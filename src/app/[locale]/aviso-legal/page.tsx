          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                {isES ? (
                  <>
                    En cumplimiento del deber de informacion establecido en el articulo 10 de la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Informacion y de Comercio Electronico (LSSI-CE), se comunican los siguientes datos identificativos del titular de este sitio web:
                  </>
                ) : (
                  <>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                {isES
                  ? "El presente sitio web tiene como finalidad informar sobre los servicios de marketing con inteligencia artificial ofrecidos por NeuroBulls, incluyendo fotografia, video, modelos y estrategia de contenido generados mediante IA. Asimismo, facilita un medio de contacto para la contratacion de dichos servicios."
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                {isES
                  ? "Todos los contenidos de este sitio web, incluyendo a titulo enunciativo pero no limitativo, textos, graficos, imagenes, logotipos, iconos, software, diseno grafico, codigo fuente y contenidos generados por inteligencia artificial, son propiedad de NeuroBulls / D Business Group ES o de sus respectivos licenciantes, y estan protegidos por las leyes de propiedad intelectual e industrial aplicables."
              ...
              <p className="text-muted-foreground leading-relaxed mt-3">
                {isES
                  ? "Queda prohibida la reproduccion, distribucion, comunicacion publica o transformacion de los contenidos de este sitio web sin la autorizacion expresa y por escrito de NeuroBulls, salvo en los casos legalmente permitidos."
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                {isES
                  ? "El usuario se compromete a hacer un uso adecuado del sitio web de conformidad con la ley, el presente aviso legal, las buenas costumbres y el orden publico. El usuario se obliga a no utilizar el sitio web con fines ilicitos o contrarios al contenido del presente aviso legal, lesivos de los derechos e intereses de terceros, o que de cualquier modo puedan danar, inutilizar o deteriorar el sitio web o impedir su normal utilizacion."
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                {isES
                  ? "NeuroBulls no se responsabiliza de los danos y perjuicios de cualquier naturaleza que pudieran derivarse del uso del sitio web, incluyendo, sin limitacion: errores u omisiones en los contenidos, falta de disponibilidad del sitio web, la transmision de virus o programas maliciosos a pesar de haber adoptado las medidas tecnologicas necesarias para evitarlo, y los danos derivados del uso indebido de los contenidos por parte de los usuarios."
              ...
              <p className="text-muted-foreground leading-relaxed mt-3">
                {isES
                  ? "NeuroBulls se reserva el derecho de modificar el contenido del sitio web sin previo aviso y sin ninguna obligacion de comunicar dichas modificaciones a los usuarios."
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                {isES
                  ? "Este sitio web puede contener enlaces a sitios de terceros. NeuroBulls no se responsabiliza del contenido, las politicas de privacidad o las practicas de sitios web de terceros. El acceso a dichos sitios se realiza bajo la exclusiva responsabilidad del usuario."
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                {isES
                  ? "El presente aviso legal se rige en todos y cada uno de sus extremos por la legislacion espanola. Para la resolucion de cualquier controversia que pudiera derivarse del acceso o uso del sitio web, NeuroBulls y el usuario acuerdan someterse expresamente a los Juzgados y Tribunales de la ciudad de Madrid, con renuncia expresa a cualquier otro fuero que pudiera corresponderles, salvo que la legislacion aplicable disponga imperativamente otro fuero distinto."
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                {isES
                  ? "Para cualquier consulta relacionada con este aviso legal, puede contactar con nosotros a traves del correo electronico"
