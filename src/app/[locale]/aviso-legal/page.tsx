        ...
        <article className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                {isES
                  ? "El presente aviso legal se rige en todos y cada uno de sus extremos por la legislación española. Para la resolución de cualquier controversia que pudiera derivarse del acceso o uso del sitio web, NeuroBulls y el usuario acuerdan someterse expresamente a los Juzgados y Tribunales competentes en España, con renuncia expresa a cualquier otro fuero que pudiera corresponderles, salvo que la legislación aplicable disponga imperativamente otro fuero distinto."
                  : "This legal notice is governed in all respects by Spanish law. For the resolution of any dispute arising from access to or use of this website, NeuroBulls and the user expressly agree to submit to the competent Courts and Tribunals in Spain, with express waiver of any other jurisdiction that may apply, unless applicable legislation imperatively provides for a different jurisdiction."}
              </p>
            </section>
