...
const automationServices = [
  {
    ...
    featuresES: [
      "Atiende llamadas telefónicas de tu negocio 24/7",
    ...
    featuresEN: [
      ...
      "Speaks Spanish, English and more languages",
  ...
  },
  {
    key: "agent",
    icon: Brain,
    priceES: "1.200€ setup + 199€/mes",
    priceEN: "€1,200 setup + €199/mo",
    featuresES: [
      ...
      "Hosting, APIs y mantenimiento incluido",
    ],
    featuresEN: [
      ...
      "Hosting, APIs and maintenance included",
    ],
  ...
  },
  {
    ...
    featuresES: [
      ...
      "Conecta todas tus herramientas entre sí (email, CRM, contabilidad, redes sociales)",
      "Cada workflow se diseña a medida para tu caso",
      "Sin límite de automatizaciones por workflow",
    ...
    featuresEN: [
      ...
      "Connect all your tools together (email, CRM, accounting, social media)",
      "Each workflow is custom-designed for your use case",
      "No limit on automations per workflow",
...
const combinedPacks = [
  {
    key: "negocio",
    priceES: "1.500€ + 149€/mes",
    priceEN: "€1,500 + €149/mo",
    badgeES: "Más Completo",
    badgeEN: "Most Complete",
    titleES: "Pack Negocio",
    titleEN: "Business Pack",
    separatelyES: "Separado costaría 1.700€ + 149€/mes",
    separatelyEN: "Separately would cost €1,700 + €149/mo",
    includesES: [
  ...
  {
    key: "total",
    priceES: "3.000€ + 249€/mes",
    priceEN: "€3,000 + €249/mo",
    badgeES: "Máximo Valor",
    badgeEN: "Best Value",
    titleES: "Pack Total",
    titleEN: "Total Pack",
    separatelyES: "Separado costaría 4.400€ + 348€/mes",
    separatelyEN: "Separately would cost €4,400 + €348/mo",
    includesES: [
...
const faqItems = {
  en: [
    ...
    {
      q: "Who pays for hosting and APIs?",
      a: "We do. The monthly fee includes everything: server hosting, AI APIs, maintenance, updates and technical support. You pay a fixed monthly fee and forget about infrastructure.",
    },
    {
  ...
  es: [
    ...
    {
      q: "¿Quién paga el hosting y las APIs?",
      a: "Nosotros. La cuota mensual incluye todo: hosting del servidor, APIs de inteligencia artificial, mantenimiento, actualizaciones y soporte técnico. Tú pagas una cuota fija mensual y te olvidas de la infraestructura.",
    },
    {
